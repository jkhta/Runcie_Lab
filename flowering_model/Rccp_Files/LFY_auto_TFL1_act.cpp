...
List c_jaeger_model_V3(NumericVector t, NumericVector X, List parms_list) {
	...
	//double K_13           = parms_list["K_13"];
        ...
        double K_13_2   = parms_list["K_13_2"];
        ...
        double h_13_2	= parms_list["h_13_2"];
    ...
    //FT:FD -> TFL1
        double p_13_2 = pow(x_13,h_13_2)/(pow(K_13_2,h_13_2) + pow(x_13,h_13_2));
    //threshold
        double thres_AP1 = pow(T_f,h_5_2) / (pow(T_f,h_5_2)  + pow(X[4],h_5_2));
	//Synthesis Rates
	  ...
	  rho(1,1) = (1 - thres_AP1)*p_13_2 + (1 - p_13_2)*thres_AP1;
	  rho(1,2) = 0;
	...
	// v1[0] = eta_leaf * t;
	  ...
	  Vout[3] = v_35S[3] + (rho(3,0)*eta_leaf2*X[5] + rho(3,1)*v2[3] + rho(3,2)*v3[3]) * (1-mutants[3]) - (delta[3] * X[3]);
	  ...
	  // Rcout << Vout[6] << "\n\n";
        ...
        //NumericVector protein_conc  = X;
    return List::create(_["Derivative"]=Vout, _["States"] = NumericVector::create(_["x_13"] = x_13, _["x_23"] = x_23, _["p_13_4"] = p_13_4, _["p_13_5"] = p_13_5, _["p_23_4"] = p_23_4, _["p_23_5"] = p_23_5, _["p_4_3"] = p_4_3, _["p_4_5"] = p_4_5, _["p_5_4"] = p_5_4, _["p_13_2"] = p_13_2));
	        //_["parm"] = K_13,
