...
op_parms <- c(sample(seq(0.01, 10, by = 0.01), 9), sample(seq(1, 4, by = 0.01), 8), sample(seq(0.000001, 1, by = 0.001), 1))
init_parms <- op_parms

low <- c(rep(0.0001, 9), rep(1, 8), 0.00001)
upp <- c(rep(10, 9), rep(4, 8), 1)
