...
tomato_veg_valentim <- function(t, X, parms=NULL,...) {
  ...
  with(as.list(parms),{
    ...
    p_14_5 = K_34_5 * x_14/(K_14_5 * K_34_5 + K_14_5 * x_34 + K_34_5 * x_14)
    p_14_6 = K_34_6 * x_14/(K_14_6 * K_34_6 + K_14_6 * x_34 + K_34_6 * x_14)

    #Amount of florigen produced per leaf
    SFT = B_1 * X[7]
    
    #Repression of TMF by FA; B_5_2 represents TMF production naturally
    TMF = B_5_2 * K_5_2/(K_5_2 + X[5])
