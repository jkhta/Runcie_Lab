...
tomato_veg_valentim <- function(t, X, parms=NULL,...) {
  ...
  with(as.list(parms),{
    ...
    FA = B_5 * X[7] + (B_14_5 * K_34_5 * x_14/(K_14_5 * K_34_5 + K_14_5 * x_34 + K_34_5 * x_14) + B_6_5*X[6]/(K_6_5 + X[6])) * K_14_5 * x_34/(K_14_5 * K_34_5 + K_14_5 * x_34 + K_34_5 * x_14)
    
    #[Activation of INF by SFT:SPGB + activation by FA] * inhibition by SP:SPGB
    INF = (B_14_6 * K_34_5 * x_14/(K_14_5 * K_34_5 + K_14_5 * x_34 + K_34_5 * x_14) + B_5_6 * X[5]/(K_5_6 + X[5])) * K_14_5 * x_34/(K_14_5 * K_34_5 + K_14_5 * x_34 + K_34_5 * x_14)
